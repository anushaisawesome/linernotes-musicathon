    ...
    <div style={{ display: "flex", gap: 13, alignItems: "stretch" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, paddingTop: 1, minWidth: 0, flex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span style={{ fontFamily: "var(--ln-mono)", fontSize: 13.5, fontWeight: 600, color: gold, letterSpacing: "0.03em" }}>
            {ts}
        ...
        {isLyric && (
          <div style={{ borderLeft: `2px solid ${gold}`, background: `${gold}10`, borderRadius: "0 8px 8px 0", padding: "8px 12px" }}>
            <span style={{ fontFamily: "var(--ln-preview)", fontStyle: "italic", fontSize: 16.5, lineHeight: 1.5, color: "rgba(var(--ln-fg-rgb),0.92)", whiteSpace: "pre-wrap" }}>
              {`“${lyricText}”`}
            </span>
          </div>
        )}
        ...
        {showAnnotation && (
          <div style={{ display: "flex", gap: 8, alignItems: "baseline" }}>
            ...
            <span style={{ fontFamily: "var(--ln-body)", fontSize: 14.5, lineHeight: 1.45, color: "rgba(var(--ln-fg-rgb),0.85)" }}>
              {annotation}
            </span>
          </div>
        )}
